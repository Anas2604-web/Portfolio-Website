    ...
    <section id="about" className="py-20 bg-white dark:bg-slate-800 transition-colors duration-300">
      <div className="container mx-auto px-6 max-w-6xl">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-800 dark:text-white mb-4 animate-fade-in">About Me</h2>
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-16">
          ...
          <div className="space-y-6 animate-slide-in-right">
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3 hover:translate-x-2 transition-transform duration-200">
        ...
        <div className="animate-fade-in animate-delay-300">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {skills.map((skill, index) => (
              <span
                key={index}
                className="bg-blue-100 dark:bg-blue-900/50 text-blue-800 dark:text-blue-300 px-4 py-2 rounded-full text-sm font-medium hover:bg-blue-200 dark:hover:bg-blue-800/70 transition-all duration-200 hover:scale-110 cursor-default"
